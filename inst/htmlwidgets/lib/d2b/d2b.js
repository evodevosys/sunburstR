var d2b = (function (exports, d3Selection, d3Interpolate, d3Transition, d3Dispatch, d3Array, d3Collection, d3Shape, d3Scales, d3ScaleChromatic, d3Color, d3SvgAnnotation, d3InterpolatePath, d3Format, d3Hierarchy, d3Sankey, d3Drag, d3Axis) {
  'use strict';
...
\ 
.d2b-pie-chart .d2b-pie-arc path { \ 
   stroke-width: 1px; \ 
   stroke: #fff \ 
} \ 
\ 
.d2b-pie-chart .d2b-pie-arc text { \ 
   fill: #fff; \ 
   font-weight: 700; \ 
   pointer-events: none; \ 
   text-anchor: middle \ 
...
\ 
.d2b-axis-wrapper .d2b-axis-background { \ 
   opacity: 0 \ 
} \ 
\ 
.d2b-chart-breadcrumbs { \ 
   width: 200px; \ 
   padding-left: 10px \ 
} \ 
\ 
.d2b-sunburst-breadcrumb .d2b-sunburst-label, \ 
.d2b-sunburst-tooltip .d2b-sunburst-label { \ 
   text-align: center \ 
} \ 
\ 
.d2b-sunburst-breadcrumb .d2b-sunburst-value, \ 
.d2b-sunburst-tooltip .d2b-sunburst-value { \ 
   font-size: 14pt; \ 
   margin-top: 5px \ 
} \ 
\ 
.d2b-sunburst-breadcrumb .d2b-sunburst-percent { \ 
   float: right \ 
} \ 
\ 
.d2b-breadcrumbs:not(.d2b-vertical) .d2b-sunburst-percent { \ 
   margin-left: 30px \ 
} \ 
\ 
.d2b-sunburst-tooltip { \ 
   text-align: center \ 
} \ 
\ 
.d2b-sunburst-tooltip .d2b-sunburst-percent { \ 
   display: inline \ 
} \ 
\ 
.d2b-sunburst-tooltip .d2b-sunburst-percent:before { \ 
   content: "(" \ 
} \ 
\ 
.d2b-sunburst-tooltip .d2b-sunburst-percent:after { \ 
   content: ")" \ 
} \ 
\ 
.d2b-sankey-link-arrow { \ 
   font-size: 10px; \ 
   position: relative; \ 
   top: -2px \ 
} \ 
\ 
.d2b-line-graph .d2b-line { \ 
   stroke-width: 1.5px; \ 
   fill: none \ 
} \ 
\ 
.d2b-area-graph .d2b-area { \ 
   stroke: none; \ 
   fill-opacity: .3 \ 
} \ 
\ 
.d2b-box .d2b-box-center, \ 
.d2b-box .d2b-box-dash, \ 
.d2b-box .d2b-box-outlier, \ 
.d2b-box .d2b-box-rect { \ 
   stroke-width: 1.5px \ 
} \ 
\ 
.d2b-box .d2b-box-rect { \ 
...
\ 
.d2b-bar-graph .d2b-bar-group rect { \ 
   opacity: .8 \ 
} \ 
\ 
.d2b-bubble-pack-graph .d2b-bubble-point { \ 
   opacity: .75 \ 
} \ 
\ 
.d2b-bubble-pack-graph .d2b-bubble-indicator rect { \ 
   fill-opacity: .25; \ 
   stroke-opacity: .9; \ 
   cursor: pointer; \ 
   stroke-width: 1px \ 
...
\ 
.d2b-bubble-pack-graph .d2b-bubble-indicator rect:hover { \ 
   stroke-width: 2px \ 
} \ 
\ 
.d2b-bubble-pack-graph .d2b-bubble-indicator path, \ 
.d2b-bubble-pack-graph .d2b-bubble-indicator text { \ 
   pointer-events: none \ 
} \ 
\ 
.d2b-plane text { \ 
...
\ 
.d2b-plane .d2b-y2-axis .d2b-axis-label, \ 
.d2b-plane .d2b-y-axis .d2b-axis-label { \ 
   -webkit-transform: rotate(-90deg); \ 
   transform: rotate(-90deg) \ 
} \ 
\ 
.d2b-plane .d2b-y2-axis .tick line, \ 
.d2b-plane .d2b-y-axis .tick line { \ 
   stroke-width: .6px \ 
} \ 
\ 
.d2b-plane .d2b-grid .tick line { \ 
   shape-rendering: crispEdges; \ 
   stroke-width: .5px; \ 
   stroke-opacity: .15 \ 
} \ 
\ 
.d2b-plane .d2b-grid .tick text { \ 
   display: none \ 
} \ 
\ 
.d2b-plane .d2b-axis-label { \ 
   fill: #000; \ 
   font-weight: 700 \ 
} \ 
\ 
.d2b-plane path.domain { \ 
   stroke-width: .4px; \ 
   stroke-opacity: .4 \ 
} \ 
\ 
...
\ 
.d2b-sunburst-arc.d2b-transparent { \ 
   fill-opacity: .2 \ 
} \ 
\ 
.d2b-sunburst-label { \ 
...
\ 
.d2b-sunburst-label.d2b-transparent { \ 
   fill-opacity: .2 \ 
} \ 
\ 
.d2b-sunburst-center { \ 
...
\ 
.d2b-sankey-links path { \ 
   fill: none \ 
} \ 
\ 
.d2b-sankey-links path, \ 
.d2b-sankey-links rect { \ 
   opacity: .4 \ 
} \ 
\ 
.d2b-sankey-links path:hover, \ 
.d2b-sankey-links rect:hover { \ 
   opacity: .6 \ 
} \ 
\ 
.d2b-sankey-nodes rect { \ 
   stroke-width: .3px; \ 
   stroke: #000; \ 
   opacity: .6 \ 
} \ 
\ 
.d2b-sankey-nodes rect:hover { \ 
   opacity: .8 \ 
} \ 
\ 
.d2b-text-anchor-end { \ 
...
\ 
.d2b-tooltip-axis .d2b-tooltip-title { \ 
   text-align: center; \ 
   background: rgba(150, 165, 175, .8); \ 
   padding: 5px 10px; \ 
   font-weight: 700; \ 
   color: #fff \ 
} \ 
\ 
.d2b-tooltip-axis .d2b-tooltip-content { \ 
   padding: 5px 10px \ 
} \ 
\ 
.d2b-tooltip-axis .d2b-tooltip-content .d2b-tooltip-row { \ 
   padding-left: 5px; \ 
...
\ 
.d2b-tooltip-axis .d2b-tooltip-content .d2b-tooltip-row:last-child { \ 
   margin-bottom: 0 \ 
} \ 
\ 
.d2b-breadcrumbs { \ 
...
\ 
.d2b-breadcrumbs .d2b-breadcrumb { \ 
   border-color: transparent; \ 
   border-style: solid; \ 
...
.d2b-breadcrumbs .d2b-breadcrumb:last-child .d2b-breadcrumb-icon:after { \ 
   position: absolute; \ 
   top: 50%; \ 
   -webkit-transform: translateY(-50%); \ 
   transform: translateY(-50%); \ 
...
\ 
.d2b-breadcrumbs:not(.d2b-vertical) .d2b-breadcrumb { \ 
...
\ 
.d2b-breadcrumbs:not(.d2b-vertical) .d2b-breadcrumb:not(:last-child) { \ 
   margin-right: 20px \ 
} \ 
\ 
.d2b-breadcrumbs:not(.d2b-vertical) .d2b-breadcrumb:not(:last-child):after { \ 
   border-color: transparent; \ 
   border-style: solid; \ 
   border-width: 7px 0 7px 6px; \ 
   border-left-color: inherit; \ 
...
\ 
.d2b-breadcrumbs.d2b-vertical .d2b-breadcrumb:not(:last-child):after { \ 
   border-color: transparent; \ 
   border-style: solid; \ 
   border-width: 6px 7px 0; \ 
   border-top-color: inherit; \ 
...
\ 
.d2b-legend .d2b-legend-item .d2b-legend-icon { \ 
   position: absolute; \ 
   top: 50%; \ 
   -webkit-transform: translateY(-50%); \ 
   transform: translateY(-50%); \ 
...
\ 
.d2b-legend .d2b-legend-item .d2b-legend-svg-icon { \ 
   margin-left: -5px; \ 
   margin-top: -5px; \ 
   pointer-events: none \ 
} \ 
\ 
.d2b-legend .d2b-legend-item .d2b-legend-svg-icon path, \ 
.d2b-legend .d2b-legend-item .d2b-legend-svg-icon text { \ 
   font-family: FontAwesome, Font Awesome\\ 5 Free; \ 
   font-weight: 700; \ 
   text-anchor: middle; \ 
   stroke-width: 1px; \ 
...
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame, \ 
.d2b-chart-frame .d2b-chart, \ 
.d2b-chart-frame .d2b-legend-frame { \ 
   position: absolute; \ 
   overflow: auto \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-legend-frame .d2b-breadcrumbs { \ 
   padding-left: 10px; \ 
   padding-right: 2px \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical), \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical) { \ 
   overflow-y: hidden \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical).d2b-legend-frame, \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical).d2b-legend-frame { \ 
   height: 20px; \ 
   text-align: center \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical).d2b-breadcrumbs-frame, \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical).d2b-breadcrumbs-frame { \ 
   height: 55px \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical) .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical) .d2b-legend, \ 
.d2b-chart-frame .d2b-breadcrumbs-frame:not(.d2b-vertical) .d2b-legend-item, \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical) .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical) .d2b-legend, \ 
.d2b-chart-frame .d2b-legend-frame:not(.d2b-vertical) .d2b-legend-item { \ 
   white-space: nowrap; \ 
   overflow-y: hidden \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical.d2b-breadcrumbs-frame, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical.d2b-breadcrumbs-frame { \ 
   width: 180px \  \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical.d2b-legend-frame, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical.d2b-legend-frame { \ 
   width: 110px \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-breadcrumbs-container, \ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-legend-container, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-breadcrumbs-container, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-legend-container { \ 
   display: table; \ 
   height: 100%; \ 
   width: 100% \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-breadcrumbs-container .d2b-legend, \ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-legend-container .d2b-legend, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-breadcrumbs-container .d2b-legend, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-legend-container .d2b-legend { \ 
   display: table-cell; \ 
   vertical-align: middle \ 
} \ 
\ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-breadcrumbs-container .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-breadcrumbs-frame.d2b-vertical .d2b-legend-container .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-breadcrumbs-container .d2b-breadcrumbs, \ 
.d2b-chart-frame .d2b-legend-frame.d2b-vertical .d2b-legend-container .d2b-breadcrumbs { \ 
   display: table-cell; \ 
   vertical-align: top \ 
}";  
  ...
  function tweenArc (context, arc) {
    ...
    context.attrTween('d', function (d) {
      ...
      var i = d3Interpolate.interpolate(this.current, d);
      return function (t) {
        _this.current = i(t);
  ...
  function tweenNumber (context) {
    ...
    context.tween('text', function (d, i) {
      ...
      var interp = d3Interpolate.interpolate(this.current, val);
      return function (t) {
        _this.textContent = format(_this.current = interp(t));
      };
    });
  }
  ...
  function base () {
    ...
    var model = {
      ...
      addDispatcher: function addDispatcher(events) {
        ...
        methodAdded(_base[prop]);
        $$[store] = d3Dispatch.dispatch.apply(_this, events);
        return model;
      },
      ...
      addAdvancedConfig: function addAdvancedConfig(config) {
        _base.advanced = function (context) {
          ...
          selection.each(function (datum) {
            if (datum.updated !== undefined) d3Selection.select(this).on('chart-updated.advanced', datum.updated);
            var el = d3Selection.select(this).selectAll('.d2b-chart-advanced').data([config(_base, datum)]);
  ...
  function tooltip () {
    ...
    var getCoords = function getCoords(d, i) {
      ...
      var at = ($$.at.call(this, d, i) || (d3Selection.event.clientX > window.innerWidth / 2 ? 'center left' : 'center right')).split(' ');
      at = {
        x: at[1],
        y: at[0]
    ...
    var mousemove = function mousemove(d, i) {
      var html = $$.html.call(this, d, i),
        ...
        x: d3Selection.event.clientX,
        y: d3Selection.event.clientY
      ...
      var my = $$.my.call(this, d, i) || (d3Selection.event.clientX > window.innerWidth / 2 ? 'left' : 'right');
    ...
    base(tooltip, $$).addProp('container', d3Selection.select('body')) //, null, updateContainer)
  ...
  function tooltipAxis () {
    ...
    var positionTooltip = function positionTooltip(tooltip, info, base) {
      ...
      if ($$.trackY) {
        ...
        if (d3Selection.event.clientY - base.y > $$.size.height / 2) {
          y = d3Selection.event.clientY - pad - tooltipBox.height;
        } else {
          y = d3Selection.event.clientY + pad;
        }
      }
      ...
      if ($$.trackX) {
        ...
        if (d3Selection.event.clientX - base.x > $$.size.width / 2) {
          x = d3Selection.event.clientX - pad - tooltipBox.width;
        } else {
          x = d3Selection.event.clientX + pad;
        }
      }
    ...
    var findPointInfo = function findPointInfo(base) {
      var cursor = {
        x: d3Selection.event.clientX - base.x,
        y: d3Selection.event.clientY - base.y
      };
      var x = Infinity,
          y = Infinity,
          points = [];
      ...
      points = points.sort(function (a, b) {
        return d3Array.ascending(a.x, b.x) || d3Array.ascending(a.y, b.y);
      });
      return {
        x: x,
        y: y,
    ...
    var enter = function enter(d, i) {
      ...
      var tooltipEl = $$.htmlContainer.selectAll('.d2b-tooltip-axis').data([tooltip]);
    ...
    var mousemove = function mousemove(d, i) {
      ...
      var baseBox = $$.svgContainer.node().getBoundingClientRect();
      baseBox = {
        x: baseBox.left,
        y: baseBox.top
      };
      ...
      $$.htmlContainer.select('.d2b-tooltip-axis').call(populateTooltip, pointInfo).call(positionTooltip, pointInfo, baseBox);
    ...
    base(tooltip, $$).addProp('htmlContainer', d3Selection.select('body')).addProp('svgContainer', null).addProp('tracker', d3Selection.select('body'), null, updateTracker).addProp('size', {
      height: 0,
      width: 0
  ...
  function stack () {
    ...
    var stack = function stack(datum) {
      ...
      xset = d3Collection.set(xset).values(); // value => index mapping of x values
      ...
      var keys = d3Array.range(0, datum.length); // transpose values for d3.stack
    ...
    base(stack, $$).addProp('stack', d3Shape.stack()).addPropFunctor('values', function (d) {
      return d;
  ...
  var color = d3Scales.scaleOrdinal(d3ScaleChromatic.schemeCategory10);

  function legend () {
    var $$ = {};
    var symbol = d3Shape.symbol().size(80);
    ...
    var legend = function legend(context) {
      ...
      legItem.style('opacity', 1).each(function (d, i) {
        ...
        var color = $$.color(d, i),
            empty = $$.empty(d, i); // legend icon customization
        ...
        svgFa.style('stroke', color).style('fill', empty ? 'white' : color).attr('transform', "translate(".concat(center.x, ",").concat(center.y * 1.65, ")"));
        svgShape.style('stroke', color).style('fill', empty ? 'white' : color).attr('transform', "translate(".concat(center.x, ",").concat(center.y, ")"));
      }); // bind events

      leg.each(function (d, i) {
        var allowEmptied = $$.allowEmptied(d, i),
            items = d3Selection.select(this).selectAll('.d2b-legend-item'),
          ...
          d3Selection.select(this.parentNode).dispatch('change', {
            bubbles: true
          });
        },
        ...
        items.each(function (d, i) {
          ...
          d3Selection.select(this).on('click', clickable ? click : null).on('dblclick', dblclickable ? dblclick : null);
        });
      });
    ...
    base(legend, $$).addPropFunctor('values', function (d) {
      ...
      return d.html;
    }).addPropFunctor('icon', d3Shape.symbolCircle).addPropFunctor('vertical', false).addPropFunctor('allowEmptied', false).addPropFunctor('clickable', false).addPropFunctor('dblclickable', false).addPropFunctor('empty', function (d) {
      return d.empty;
  ...
  function chartFrame () {
    ...
    var chartFrame = function chartFrame(context) {
      ...
      selection.each(function (d) {
        var frame = d3Selection.select(this).select('.d2b-chart-frame'),
            frameUpdate = frame,
  ...
  function median(arr, value, weight) {
    ...
    var newArray = arr.filter(function (a) {
      ...
      return d3Array.ascending(value(a), value(b));
    });
    midWeight = Math.round(d3Array.sum(newArray, function (item) {
      return weight(item);
    }) / 2 * 1e12) / 1e12;
  ...
  function range(arr, value) {
    ...
    var valueExtent = d3Array.extent(arr, value);
  ...
  function midpoint(arr, value) {
    ...
    if (arr.length) return d3Array.mean(d3Array.extent(arr, value));
  }
  ...
  function point () {
    ...
    var point = function point(context) {
      ...
      selection.each(function (d, i) {
        ...
        d3Selection.select(this).on('mouseover.d2b-point', active ? mouseover : null).on('mouseout.d2b-point', active ? mouseout : null);
      });
    ...
    function mouseover(d, i) {
      ...
      d3Selection.select(this).select('path.d2b-point-back').transition().duration(100).attr('d', symbolBig);
      d3Selection.select(this).select('path.d2b-point-front').transition().duration(100).style('opacity', empty ? 0.5 : 1).attr('d', symbolSmall);
    }

    function mouseout(d, i) {
      var empty = $$.empty.call(this, d, i);
      d3Selection.select(this).select('path.d2b-point-back').transition().duration(100).attr('d', symbolNormal);
      d3Selection.select(this).select('path.d2b-point-front').transition().duration(100).style('opacity', empty ? 0 : 1).attr('d', symbolSmall);
    }
  ...
  function svgPie () {
    ...
    var pie = function pie(context) {
      ...
      pieSvg.each(function (values) {
        var el = d3Selection.select(this); // select arc group and get their old data
    ...
    base(pie, $$).addProp('arc', d3Shape.arc()).addProp('pie', d3Shape.pie().sort(null)).addPropFunctor('values', function (d) {
      return d;
  ...
  var updateAxis = function updateAxis(context, annotation, data, scales) {
    var selection = context.selection ? context.selection() : context,
        node = selection.node(),
    ...
    aSvg.each(function (a) {
      ...
      if (context !== selection) {
        aSvg.transition(context).tween('annotation-tween', function () {
          ...
          var i = d3Interpolate.interpolateObject(this.__subject || getSubject(a, scales), aCopy.subject);
          return function (t) {
  ...
  function svgLine () {
    ...
    var line = function line(context) {
      ...
      if (context !== selection) {
        ...
        var tweenD = function tweenD(d) {
          ...
          var maxX = d3Array.max(d.values, function (dd) {
            return dd.x;
          });
          var minX = d3Array.min(d.values, function (dd) {
            return dd.x;
          });
    ...
    var stackNest = d3Collection.nest().key(function (d) {
      var key = d.stackBy;
      return key !== false && key !== null ? key : d2bid();
    });
    /* Inherit from base model */

    base(line, $$).addProp('line', d3Shape.line()).addProp('stack', stacker.stack(), null, function (d) {
      return stacker.stack(d);
    }).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'line').addPropFunctor('graphs', function (d) {
      return d;
    }) // graph props
  ...
  function svgArea () {
    ...
    base(area, $$).addProp('area', d3Shape.area()).addProp('stack', stacker.stack(), null, function (d) {
      return stacker.stack(d);
    }).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'area').addPropFunctor('graphs', function (d) {
      return d;
    }) // graph props
  ...
  function svgScatter () {
    ...
    base(scatter, $$).addProp('point', point().active(true)).addProp('stack', stacker.stack(), null, function (d) {
      return stacker.stack(d);
    }).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'scatter').addPropFunctor('graphs', function (d) {
      return d;
    }) // graph props
    .addPropFunctor('align', 'y1').addPropFunctor('tooltipGraph', function (d) {
      return d.tooltipGraph;
  ...
  function svgBar () {
    ...
    var bar = function bar(context) {
      ...
      selection.each(function (d, i) {
        ...
        var graphsSVG = d3Selection.select(this).selectAll('.d2b-bar-graphs').data(function (d) {
          return [d];
        });
        ...
        if (context !== selection) {
          ...
          graphExit.each(function (d) {
            var shift = d.shift;
            if (shift === null) shift = x.bandwidth ? x.bandwidth() / 2 : 0;
            var barExit = d3Selection.select(this).selectAll('.d2b-bar-group').transition(context);
        ...
        graphUpdate.each(function (d) {
          var graph = d3Selection.select(this);
          var shift = d.shift;
    ...
    function getExtentScale(y) {
      ...
      scale.sorted = function (point) {
        return scale(point).slice().sort(d3Array.ascending);
      };
    ...
    function modifyBaseline(graphs, baseline) {
      ...
      if (baseline === null) {
        ...
        var range = d3Array.extent(values.map(function (d) {
          return d.extent[1];
        }));
    ...
    base(bar, $$).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'bar').addPropFunctor('graphs', function (d) {
      return d;
  ...
  function box () {
    ...
    base(box, $$).addProp('scale', d3Scales.scaleLinear()).addProp('enterScale', null).addProp('valueFormat', d3Format.format(',')).addProp('orient', 'vertical').addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropFunctor('data', function (d) {
      return d;
  ...
  function svgBoxPlot () {
    ...
    base(boxPlot, $$).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('box', box()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'boxPlot').addPropFunctor('graphs', function (d) {
      return d;
    }) // graph props
    .addPropFunctor('tooltipGraph', function (d) {
      return d.tooltipGraph;
  ...
  function svgBubblePack () {
    var $$ = {};
    var indicatorSymbol = d3Shape.symbol().size(80);
      ...
      el.each(function (d) {
        ...
        if (d.children.length && !d.data.expanded) {
          el.attr('cursor', 'pointer').on('click', function () {
            d3Selection.select(this).dispatch('change', {
              bubbles: true,
              cancelable: true
            });
    ...
    function renderIndicator(el) {
      el.each(function (d) {
        var el = d3Selection.select(this).classed('d2b-active', d.data.expanded);
    ...
    function setStructure(d, tendancy) {
      ...
      d.size = oreq(d.size, d3Array.sum(d.leaves, function (d) {
        return d.size;
      }));
    ...
    base(bubblePack, $$).addProp('point', point().size(function (d) {
      return d.size * 100;
    })).addProp('x', d3Scales.scaleLinear()).addProp('y', d3Scales.scaleLinear()).addProp('annotation', d3SvgAnnotation.annotation ? d3SvgAnnotation.annotation() : null).addPropGet('type', 'bubblePack').addPropFunctor('duration', 250).addPropFunctor('graphs', function (d) {
      return d;
    }) // graph props
  ...
  function svgSunburst () {
    var $$ = {}; // const arc = arc().cornerRadius(5);
    ...
    base(sunburst, $$).addProp('arc', d3Shape.arc()).addProp('pie', d3Shape.pie().sort(null)).addProp('ancestorBanding', d3Scales.scaleLinear()).addProp('descendantBanding', d3Scales.scalePow().exponent(0.85)) // Datum Level Accessors
    ...
    function getHierarchy(d) {
      ...
      return updateDescendants(d3Hierarchy.hierarchy(d, $$.children).sum(function (d) {
    ...
    function getValue(node) {
      return oreq(node.size, node.children ? d3Array.sum(node.children, getValue) : 0);
    }
    ...
    function updateNodes(newData, type, depth, startAngle, endAngle, tools) {
      ...
      arcUpdate.select(".d2b-sunburst-".concat(type, "-children.").concat(levelClass)).each(function (d) {
        ...
        var childrenTotal = d3Array.sum(children, function (c) {
          return c.value;
        });
      ...
      selection.each(function (datum) {
        ...
        node.each(function (d) {
          if (d.draggableX || d.draggableY) {
            d3Selection.select(this).classed('d2b-draggable', true).call(d3Drag.drag().on('drag', drag));
          } else {
            d3Selection.select(this).classed('d2b-draggable', false).on('.drag', null);
          }
        ...
        function drag(d) {
          if (d.draggableX) {
            d.x0 = Math.max(0, Math.min(size.width - nodeWidth, d.x0 + d3Selection.event.dx));
            d.x1 = d.x0 + nodeWidth;
          ...
          if (d.draggableY) {
            var height = d.y1 - d.y0;
            d.y0 = Math.max(0, Math.min(size.height - (d.y1 - d.y0), d.y0 + d3Selection.event.dy));
            d.y1 = d.y0 + height;
        ...
        function updater() {
          ...
          l.each(function (d) {
            var l = d3Selection.select(this); // special case draw a rect
  ...
  function plane () {
    ...
    function wrapTicks(el, axis) {
      ...
      el.selectAll('.tick text').each(function () {
        var tick = d3Selection.select(this);
  ...
  function chartAxisAdvanced (chart, datum) {
    ...
    chart.tooltipConfig.proxy(function (tooltipAxis) {
    ...
    chart.graphTooltipConfig.proxy(function (graph) {
    ...
    ['x', 'x2', 'y', 'y2'].forEach(function (axis) {
      ...
      chart[axis].proxy(function (d, points) {
        ...
        if (typeof axisConfig.axis === 'function') {
          ...
          switch ("".concat(axis, "-").concat(config.orient)) {
            case 'x-outer':
              config.axis = d3Axis.axisBottom();
              break;

            case 'y-outer':
              config.axis = d3Axis.axisLeft();
              break;

            case 'x2-outer':
              config.axis = d3Axis.axisTop();
              break;

            case 'y2-outer':
              config.axis = d3Axis.axisRight();
              break;
        ...
        if (typeof scaleConfig === 'function') {
          ...
          var scaleGenerator = d3Scales["scale".concat(type.charAt(0).toUpperCase() + type.slice(1))];
          ...
          switch (type) {
            ...
            default:
              domain = d3Array.extent(values.map(Number));
          }
        }
  ...
  function axis () {
    ...
    function update(datum, transition) {
      var container = d3Selection.select(this),
      ...
      set.each(function (s) {
        ...
        this.gen.each(function (d, i) {
          var gen = d3Selection.select(this),
      ...
      set.each(function (s) {
        ...
        d3Selection.select(this).on('change', function () {
          return container.transition().duration(duration).call(chart);
        });
      ...
      if ($$.annotation) {
        ...
        backAnnotationsUpdate.call(updateAxis, $$.annotation, annotations.filter(function (a) {
          return a.z === 'back';
        }), annotationScales);
        frontAnnotationsUpdate.call(updateAxis, $$.annotation, annotations.filter(function (a) {
          return a.z === 'front';
        }), annotationScales);
      } // configure tooltip
    ...
    var bandDefault = d3Scales.scaleBand(),
        linearDefault = d3Scales.scaleLinear(),
        axisDefaults = {
      x: {
    ...
    function getScale(points, defaults) {
      var band = points.some(function (d) {
        return isNaN(d);
          ...
          domain = band ? d3Collection.set(points).values() : d3Array.extent(points).map(function (d) {
        return d || 0;
      }),
  ...
  function chartSunburstAdvanced (chart, datum) {
    ...
    chart.breadcrumbs().vertical.conditionally(breadcrumbsConfig.orient, ['right', 'left'].includes(breadcrumbsConfig.orient)).html.proxy(function (d) {
      var data = d.data;
      var value = d.value;
  ...
  function sunburst () {
    ...
    var formatValue = d3Format.format(',.0f'),
        formatPercent = d3Format.format('.1%');
  ...
  function sankey$1 () {
    ...
    base(chart, $$).addProp('chartFrame', chartFrame().legendEnabled(false).breadcrumbsEnabled(false)).addProp('sankey', sankey()).addProp('nodeTooltip', defaultNodeTooltip).addProp('linkTooltip', defaultLinkTooltip).addAdvancedConfig(chartSankeyAdvanced);
    return chart;
  }
